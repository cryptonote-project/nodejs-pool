...
function Coin(data){
    ...
    this.coinDevAddress = "";  // Pool Ops Address
    this.poolDevAddress = "";  // Developer Address
    ...
    this.prefix = 1078; // CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX
    this.intPrefix = 19; // CRYPTONOTE_PUBLIC_INTEGRATED_ADDRESS_BASE58_PREFIX 
    this.subPrefix = 42; // CRYPTONOTE_PUBLIC_SUBADDRESS_BASE58_PREFIX

    if (global.config.general.testnet === true){
        this.prefix = 53; // CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX 
        this.intPrefix = 54; // CRYPTONOTE_PUBLIC_INTEGRATED_ADDRESS_BASE58_PREFIX
        this.subPrefix = 63; // CRYPTONOTE_PUBLIC_SUBADDRESS_BASE58_PREFIX
    }

    this.supportsAutoExchange = false; // true when ready
