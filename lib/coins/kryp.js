...
function Coin(data){
    ...
    this.prefix = 110; // CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX
    this.intPrefix = 19; // CRYPTONOTE_PUBLIC_INTEGRATED_ADDRESS_BASE58_PREFIX 

    if (global.config.general.testnet === true){
        this.prefix = 18018; // CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX 
        this.intPrefix = 18019; // CRYPTONOTE_PUBLIC_INTEGRATED_ADDRESS_BASE58_PREFIX
    }
